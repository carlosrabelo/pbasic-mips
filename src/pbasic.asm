...
# DO_LET is provided by the LET command checkbox.
# DO_GOTO is provided by the GOTO command checkbox.
# DO_GOSUB and DO_RETURN are provided by the GOSUB/RETURN checkbox.
# DO_IF is provided by the IF/THEN checkbox.
# DO_INPUT is provided by the INPUT command checkbox.
